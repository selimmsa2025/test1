...
/**
 * API 인증 관리 조회 결과용 정보 SVO(파라미터).
 * 
 * @name_ko API 인증 관리 화면표시 SVO(파라미터)
 * @author lsc
 */
@Schema(description = "API 인증키 관리")
@Getter
@Setter
public class ApiCertKeyReqSVO implements Serializable {
	...
	private List<CertInfoSVO> paramList;
