...
/**
 * 표준API관리 조회 결과용 정보 VO.
 * @name_ko 표준API관리 화면표시 VO
 * @author lsc, ksj
 */
@Schema(description = "표준API")
@Getter
@Setter
public class AmDVO extends CmmnVO  {

	private static final long serialVersionUID = -8310959696906771297L;
	...
	private List<AmArtcDVO> paramList;
	
	@Schema(description = "카탈로그등록여부")
	private String gdsGdntcRegYn; //
	
	@Schema(description = "최신버전수정가능여부")
	private String lastVerEditYn;
