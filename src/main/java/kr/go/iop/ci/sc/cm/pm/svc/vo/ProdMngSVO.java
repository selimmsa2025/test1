 ...
 */
package kr.go.iop.ci.sc.cm.pm.svc.vo;
...
@Getter
@Setter
public class ProdMngSVO implements Serializable{
	...
	@Pattern(
		regexp = "^(http|https)://[^%\\\\^$]*$",
		message = "URL은 http:// 또는 https:// 로 시작하고 올바른 도메인을 포함해야 합니다. % ^ $ 같은 특수문자는 사용할 수 없습니다."
	)
