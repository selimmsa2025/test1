...
/**
 * 표준API관리 조회 결과용 정보 VO(파라미터).
 * @name_ko 표준API관리 화면표시 VO(파라미터)
 * @author lsc, ksj
 */
@Schema(description = "표준API 항목(파라미터)")
@Getter
@Setter
public class AmArtcDVO implements Serializable {

	private static final long serialVersionUID = 144175733951708906L;
	...
	@Schema(description = "API항목구분코드명")
	private String apiArtclSeNm;
